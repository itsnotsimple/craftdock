...
<div align="center">
  ...
  <h1 style="margin-top: 12px; margin-bottom: 4px;">CraftDock v2.3.0</h1>
  ...
  <p>
    <a href="https://github.com/itsnotsimple/craftdock/releases/latest"><img src="https://img.shields.io/badge/version-2.3.0-sky.svg?style=for-the-badge&logo=electron" alt="Version 2.3.0" /></a>
...
|:---|:---|:---|
| 🪟 **Windows** | 64-bit (x64) | [**`CraftDock-2.3.0-Windows-Setup.exe`**](https://github.com/itsnotsimple/craftdock/releases/latest) |
| 🍏 **macOS** | Apple Silicon (**M1 / M2 / M3 / M4**) | [**`CraftDock-2.3.0-macOS-arm64.dmg`**](https://github.com/itsnotsimple/craftdock/releases/latest) |
| 🍏 **macOS** | Intel Processor (x64) | [**`CraftDock-2.3.0-macOS-x64.dmg`**](https://github.com/itsnotsimple/craftdock/releases/latest) |
