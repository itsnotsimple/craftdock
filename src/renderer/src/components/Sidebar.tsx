...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 bg-slate-950/40 border-r border-white/[0.08] flex flex-col justify-between shrink-0 select-none h-screen backdrop-blur-2xl relative z-10">
      {/* App Header / Brand */}
      <div>
        <div className="p-5 border-b border-white/[0.06] flex items-center gap-3.5 bg-white/[0.02]">
          <div className="relative group">
            ...
            <span className="absolute -bottom-0.5 -right-0.5 flex h-3 w-3">
              ...
              <span className="relative inline-flex rounded-full h-3 w-3 bg-sky-500 border-2 border-slate-950"></span>
            </span>
          </div>
          <div>
        ...
        <div className="p-3 space-y-1.5">
          ...
          >
            {currentTab === 'library' && (
              <span className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-sky-400 rounded-r-full shadow-[0_0_8px_rgba(56,189,248,0.8)]" />
            )}
            <div className="flex items-center gap-3">
              <Server className={`w-4 h-4 transition-transform group-hover:scale-110 ${currentTab === 'library' ? 'text-sky-400' : 'text-slate-400'}`} />
          ...
          >
            ...
            <PlusCircle className={`w-4 h-4 text-sky-400 transition-transform group-hover:scale-110`} />
          ...
          {activeServer && (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <Terminal className="w-4 h-4 text-sky-400 transition-transform group-hover:scale-110" />
      ...
      <div className="p-4 border-t border-white/[0.06] bg-white/[0.01] space-y-3">
        {runningServersCount > 0 && (
          <div className="flex items-center gap-2.5 text-xs px-3 py-2 rounded-xl bg-sky-950/40 border border-sky-500/30 text-sky-300 shadow-sm">
